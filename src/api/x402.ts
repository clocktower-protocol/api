...
export const API_ROUTE_MANIFEST: RouteManifestEntry[] = [
  ...
  { method: 'POST', path: '/api/check_subscribe_readiness_by_id', priceKey: 'checkSubscribeReadiness', description: 'Check subscribe readiness by subscription id' },
  ...
  { method: 'POST', path: '/api/prepare/subscribe_by_id', priceKey: 'prepareSubscribe', description: 'Prepare subscribe by subscription id' },
  ...
  { method: 'POST', path: '/api/prepare/cancel_subscription_by_id', priceKey: 'prepareCancelSubscription', description: 'Prepare cancel subscription by id' },
  { method: 'POST', path: '/api/prepare/unsubscribe', priceKey: 'prepareUnsubscribe', description: 'Prepare unsubscribe' },
  { method: 'POST', path: '/api/prepare/unsubscribe_by_id', priceKey: 'prepareUnsubscribe', description: 'Prepare unsubscribe by id' },
  ...
  { method: 'POST', path: '/api/prepare/unsubscribe_by_provider_by_id', priceKey: 'prepareUnsubscribeByProvider', description: 'Prepare unsubscribe by provider using subscription id' },
